...
class CalculatorGUI(tk.Frame):
    ...
    def initialize_inputs(self) -> None:
        ...
        input_frame = tk.Frame(self.root, background="lightgrey")
    ...
    def initialize_output(self) -> None:
        ...
        output_frame = tk.Frame(self.root, background="lightgrey")
    ...
    def calculate(self) -> None:
        ...
        try:
            ...
            operator: Literal["+", "-", "*", "/"] = self.operator_entry.get()  # type: ignore
